...
public final class CorfuProtocolLogUnit {
    ...
    public static RequestPayloadMsg getRdmaServerRequestMsg() {
        return RequestPayloadMsg.newBuilder()
                .setRdmaServerRequest(RdmaServerRequestMsg.newBuilder()
                        .build())
                .build();
    }

    public static ResponsePayloadMsg getRdmaServerResponseMsg(String host, int port) {
        return ResponsePayloadMsg.newBuilder()
                .setRdmaServerResponse(RdmaServerResponseMsg.newBuilder()
