...
public class LogUnitHandler implements IClient, IHandler<LogUnitClient> {
    ...
    @ResponseHandler(type = PayloadCase.RDMA_SERVER_RESPONSE)
    private static Object handleRdmaServerResponse(ResponseMsg msg, ChannelHandlerContext ctx, IClientRouter router) {
        return msg.getPayload().getRdmaServerResponse();
    }
